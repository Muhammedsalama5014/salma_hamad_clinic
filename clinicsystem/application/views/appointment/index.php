		...
		<table class="table table-bordered table-hover table-condensed" cellspacing="0" width="100%" id="table-export">
			<thead>
				<tr>
					...
					<th><?php echo translate('civil') . " " . translate('id'); ?></th>
					<th><?php echo translate('patient') . " " . translate('name'); ?></th>
					<th><?php echo translate('patient') . " " . translate('phone'); ?></th>
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo html_escape($row['patient_civil']); ?></td>
					<td><?php echo html_escape($row['patient_name'])." ( ".html_escape($row['patient_patient_id'])." ) "; ?></td>
					<td><?php echo html_escape($row['patient_phone']); ?></td>
					...
					<td><?php echo html_escape($row['service_name']); ?></td>
				    ...
				    <td>
						<?php
						/*if ($row['created_by_user_id'] == $login_user_id) {
							$is_edit = 1;
						}*/

						$is_edit = 0;
						
						if (loggedin_role_id() == 2 || loggedin_role_id() == 6) {
							$is_edit = 1;
						}
						
						if ($is_superadmin_edit==1) {
							$is_edit = 1;

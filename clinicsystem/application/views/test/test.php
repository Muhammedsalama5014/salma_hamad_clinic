	...
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="<?php echo (!isset($validation_error) ? 'active' : ''); ?>">
				<a href="#list" data-toggle="tab"><i class="fas fa-list-ul"></i> <?php echo "Service". " " . translate('list'); ?></a>
			</li>
<?php if (get_permission('lab_test', 'is_add')){ ?>
			<li class="<?php echo (isset($validation_error) ? 'active' : ''); ?>">
				<a href="#create" data-toggle="tab"><i class="far fa-edit"></i> <?php echo translate('create') . " " . "Service"; ?></a>
			</li>
<?php } ?>
		</ul>
		...
		<div class="tab-content">
			<div id="list" class="tab-pane <?php echo (!isset($validation_error) ? 'active' : ''); ?>">
				<div class="mb-md">
					<div class="export_title"><?php echo "Service" . " " . translate('list'); ?></div>
					<table class="table table-bordered table-hover table-condensed" cellspacing="0" width="100%" id="table-export">
						<thead>
							<tr>
								...
								<th><?php echo "Service" . " " . translate('category'); ?></th>
								<th><?php echo "Service" . " " . translate('name'); ?></th>
								<th><?php echo "Service" . " " . translate('code'); ?></th>
			...
			<div class="tab-pane <?php echo (isset($validation_error) ? 'active' : ''); ?>" id="create">
				<?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered')); ?>
					<div class="form-group <?php if (form_error('category_id')) echo 'has-error'; ?>">
						<label class="col-md-3 control-label"><?php echo "Service Category" // translate('test_category'); ?> <span class="required">*</span></label>
						<div class="col-md-6">
							<?php
					...
					<div class="form-group <?php if (form_error('test_name')) echo 'has-error'; ?>">
						<label class="col-md-3 control-label"><?php echo "Service Name" // translate('test_name'); ?> <span class="required">*</span></label>
						<div class="col-md-6">
					...
					<div class="form-group <?php if (form_error('test_code')) echo 'has-error'; ?>">
						<label class="col-md-3 control-label"><?php echo "Service Code" // translate('test_code'); ?> <span class="required">*</span></label>
						<div class="col-md-6">
					...
					<div class="form-group <?php if (form_error('from_date')) echo 'has-error'; ?>">
						<label  class="col-md-3 control-label"><?php echo translate('From Date'); ?> <span class="required">*</span></label>
						<div class="col-md-6 mb-md">
							<input type="text" class="form-control" name="from_date" value="<?php echo set_value('from_date', date('Y-m-d')); ?>" data-plugin-datepicker 
							data-plugin-options='{ "todayHighlight" : true }' />
					...
					<div class="form-group <?php if (form_error('to_date')) echo 'has-error'; ?>">
						<label  class="col-md-3 control-label"><?php echo translate('To Date'); ?> <span class="required">*</span></label>
						<div class="col-md-6 mb-md">
							<input type="text" class="form-control" name="to_date" value="<?php echo set_value('to_date', date('Y-m-d')); ?>" data-plugin-datepicker 
							data-plugin-options='{ "todayHighlight" : true }' />

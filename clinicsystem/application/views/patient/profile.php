        ...
        <div class="panel-group" id="accordion">
            <div class="panel panel-accordion">
                ...
                <div id="profile" class="accordion-body collapse <?php echo ($this->session->flashdata('profile_tab') ? 'in' : ''); ?>">
                    ...
                    <input name="form_type" type="hidden" value="edit">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-sm">
                                ...
                                <div class="form-group <?php if (form_error('patient_id')) echo 'has-error'; ?>">
                                    <label class="control-label"><?php echo translate('patient file id'); ?> <span class="required">*</span></label>
                                    <input class="form-control" name="patient_id" type="text" value="<?php echo set_value('patient_id', $patient['patient_id']); ?>" />
                        ...
                        <div class="col-md-7 mb-sm">
                            <div class="form-group ">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="far fa-user"></i></span>
                                    <input class="form-control" name="nationality" type="text" value="<?php echo $patient['nationality']  ?>">
                                </div>
                        ...
                        <div class="col-md-5 mb-sm">
                            <div class="form-group ">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="far fa-user"></i></span>
                                    <input class="form-control" name="nationalid" type="text" value="<?php echo $patient['nationalid']  ?>">
                                </div>
                        ...
                        <div class="col-md-6 mb-sm">
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" name="patientcase" value="<?php echo $patient['patientcase']  ?>" > 
                                </div>
                        </div>
                        <div class="col-md-6 mb-sm">
                                <div class="form-group ">
                                    <label class="control-label">Known us from  <span class="required">*</span></label> <br>
                                    <select class="form-select form-control" name="knownusfrom" aria-label="Default select example">
                                            
                                            <option value="<?php echo $patient['knownusfrom']  ?>" selected> <?php echo $patient['knownusfrom']  ?> </option>
                        ...
                        <div class="col-md-6 mb-sm">
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" name="job" value="<?php echo $patient['job']  ?>" > 
                                </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-sm">
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" name="debitbalance" value="<?php echo $patient['debitbalance']  ?>" >   
                                </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-sm">
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" name="creditbalance" value="<?php echo $patient['creditbalance']  ?>" > 
                                </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-sm">
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" name="tel" value="<?php echo $patient['tel']  ?>" > 
                                </div>
                        </div>
                            ...
                            <div class="col-md-6 mb-sm">
                                <div class="form-group <?php if (form_error('mobile_no')) echo 'has-error'; ?>">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <?php /*<input class="form-control mobile_no" name="mobile_no" type="text" value="<?php echo set_value('mobile_no', $patient['mobileno']); ?>" required/>*/?>
                                        <input class="form-control" name="mobile_no" type="text" value="<?php echo set_value('mobile_no', $patient['mobileno']); ?>" required/>
                                    </div>
            ...
            <div class="panel panel-accordion">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        ...
                        href="#appointmentsschedule">
                            <i class="fas fa-notes-medical"></i> <?php echo translate('Appointments schedule'); ?>
                        </a>
                    </h4>
                </div>
                <div id="appointmentsschedule" class="accordion-body collapse <?php echo ($this->session->flashdata('appointmentsschedule') ? 'in' : ''); ?>">
                   
                   
            <div class="panel-body">
            <table class="table table-bordered table-hover table-condensed" cellspacing="0" width="100%" id="table-exports">
            <thead>
                <tr>
                    <th><?php echo translate('Day'); ?></th>
                    <th><?php echo translate('Date'); ?></th>
                    <th><?php echo translate('Time') ; ?></th>
                    <th><?php echo translate('Service Name') ; ?></th>
                    <th><?php echo translate('Case') ; ?></th>
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo date('l', strtotime($row['appointment_date'])); ?></td>
                   ...
                   <td><?php 
                        ...
                        if($status == 1) {
                            ...
                            $status = translate('Not Confirmed');
                            $labelMode = 'label-info-black';
                        }elseif($status == 5) {
                            $status = translate('Cancel');
                            $labelMode = 'label-info-red';
                        }elseif($status == 6) {
                            $status = translate('Waiting');
                            $labelMode = 'label-info-yellow';
                        }elseif($status == 7) {
                            $status = translate('Received');
                            $labelMode = 'label-info-blue';
                        }
                        echo "<span class='label " . $labelMode. "'>" . $status . "</span>";
                    ?>
...
<script>
    let oldphone = "<?php echo $patient['mobileno']; ?>";

...
<style>
	...
	.invoice table.table > thead:first-child > tr > th{
		background-color: #cea8a7 !important;
		border-bottom: unset;
		color: white;
	}
	.even{
...
<?php endif; ?>
		...
		<div class="tab-content">
			...
			<div id="invoice" class="tab-pane <?php echo (empty($active_tab) || $active_tab == 1 ? 'active' : ''); ?>">
				<div id="bill_print">
					<div class="invoice">
						<header class="clearfix" style="	border: unset !important;">
							<div class="row">
								<div class="col-xs-6">
									<div class="ib">
										<img src="<?php echo base_url('uploads/app_image/printing-logo.png'); ?>" alt="Img" style="width: 200px;" />
									</div>
								</div>
								<div class="col-xs-6 text-right">
									<h1 class="mt-none mb-none text-dark">INVOICE</h1>
									<h4 class="mt-none mb-none text-dark">Invoice No: <?php echo html_escape($test_bill['bill_no']); ?></h4>
									<p class="mb-none">
									...
									<p class="mb-none" style="display: none;">
								...
								<div class="col-xs-6">
									<div class="bill-data">
										...
										<address>
											...
											echo translate('file_id_number') . ' : ' . $test_bill['patient_id'] .  '<br>';
											echo translate('mobile_no') .' : '. $test_bill['p_mobileno'] . '<br>'; 
											echo translate('civil_id') .' : '. $test_bill['p_civil_id'] . '<br>'; 
								...
								<div class="col-xs-6">
									<div class="bill-data text-right">
										<p class="h5 mb-xs text-dark " >
											...
											echo html_escape($net_amount) . " ( ". ucwords($f->format($net_amount)) . " $currency )";
											?>
										</p>

										<p class="h5 mb-xs text-dark " >
											<?php echo translate('due'); ?> (<?php echo html_escape($currency_symbol); ?>) :
											<?php
											$f = new NumberFormatter("en", NumberFormatter::SPELLOUT);
										...
										<p class="h5 mb-xs text-dark text-weight-semibold" ><?php echo translate('Date'); ?> :<?php echo _d($test_bill['date']); ?></p>

										<p class="h5 mb-xs text-dark text-weight-semibold" style="display:none"><?php echo translate('from'); ?> :</p>
						...
						<div class="table-responsive">
							<table class="table invoice-items table-hover tbr-top mb-none">
								<thead>
									<tr class="text-dark">
										<th id="cell-id" class="text-weight-semibold" 
										style="background-color: #cea8a7 !important ;border-bottom: unset !important;color: white !important;">#</th>
										<th id="cell-desc" class="text-weight-semibold"
										style="background-color: #cea8a7 !important;border-bottom: unset !important;color: white !important;"
										><?php echo translate("category"); ?></th>
										<th id="cell-item" class="text-weight-semibold"
										style="background-color: #cea8a7 !important;border-bottom: unset !important;color: white !important;"
										><?php echo translate("Service Name	") ; ?></th>
										<th id="cell-price" class="text-weight-semibold"
										style="background-color: #cea8a7 !important;border-bottom: unset !important;color: white !important;"
										><?php echo translate("price"); ?></th>
										<th id="cell-qty" class="text-weight-semibold"
										style="background-color: #cea8a7 !important;border-bottom: unset !important;color: white !important;"
                                        ><?php echo translate("Quantity"); ?></th>
										<th id="cell-qty" class="text-weight-semibold"
										style="background-color: #cea8a7 !important;border-bottom: unset !important;color: white !important;"
                                        ><?php echo translate("discount"); ?></th>
										<th id="cell-total" class="text-center text-weight-semibold"
										style="background-color: #cea8a7 !important;border-bottom: unset !important;color: white !important;"
										><?php echo translate("total"); ?></th>
									</tr>
								</thead>
								<tbody>
									<?php
										$count = 1;
										$class="background: #d1d2d3 !important; color: black;border-bottom: 0px !important;";
										foreach ( $bill_details as $row ) {
											$price = $row['price'];
											$quantity = $row['quantity'];
											$discount = $row['discount'];
											if ($class==='background: #d1d2d3 !important; color: black;border-bottom: 0px !important;') {

												$class = "background: #eff1f2 !important; color: black;border-bottom: 0px !important;";
											} else {
												$class="background: #d1d2d3 !important; color: black;border-bottom: 0px !important;";
									...
									?>
									<tr>
										<td style="<?= $class; ?>"><?php echo $count++; ?></td>
										<td style="<?= $class; ?>"><?php echo html_escape($row['test_category']); ?></td>
										<td style="<?= $class; ?>"><?php echo html_escape($row['test_name']); ?></td>
										<td style="<?= $class; ?>"><?php echo html_escape($currency_symbol . $price); ?></td>
										<td style="<?= $class; ?>"><?php echo html_escape($quantity); ?></td>
										<td style="<?= $class; ?>"><?php echo html_escape($currency_symbol . $discount); ?></td>
										<td class="text-center " style="<?= $class; ?>"><?php echo html_escape($currency_symbol . (($price * $quantity ) - $discount)); ?></td>
									</tr>
									<?php } ?>
								</tbody>
							</table>
								...
								<div class="col-lg-5 pull-right">
									<ul class="amounts">
										...
										<li><?php echo translate('tax'); ?> (<?php echo html_escape($currency_symbol); ?>) : <?php echo html_escape($tax_amount); ?></li>
											<?php if ($status == 3){?>
												<li style="background-color: #cea8a7 !important;border-bottom: unset; color: white !important;">
													<strong style="color:white !important"><?php echo translate('Grand Total'); ?> (<?php echo html_escape($currency_symbol); ?>) : </strong> 
													<?php
													$f = new NumberFormatter("en", NumberFormatter::SPELLOUT);
													echo html_escape($net_amount) . " ( ". ucwords($f->format($net_amount)) . " $currency )";
													?>
												...
												?>
													<li><?php echo translate('paid'); ?> <?php echo html_escape($payment['pay_via']); ?> (<?php echo html_escape($currency_symbol); ?>) : <?php echo $payment['amount']; ?></li>
													<li><?php echo translate('remarks'); ?> : <?php echo html_escape($payment['remarks']); ?></li>
										...
										<?php }else{ ?>
											<li  style="background-color: #cea8a7 !important;border-bottom: unset; color: white !important;"><?php echo translate('Grand Total'); ?> (<?php echo html_escape($currency_symbol); ?>) : <?php echo html_escape($net_amount); ?></li>
										...
										<li><?php echo translate('authorization_no'); ?> : <?php echo html_escape($test_bill['authorization_no']); ?></li>
						...
						<div class="row mt-xxlg">
							<div class="col-xs-8">
								...
								<br><br><br><br>
								<div class="auth-signatory" style="width:100%">
							...
							<div class="col-xs-4">
								<div class="text-right">
									<table style="width: 100%;">
										<tr>
											<td>
												<img src="<?php echo base_url('assets/images/phone.png'); ?>" style="width: 35%;">
											</td>
											<td style="text-align: left;">
												<?php echo html_escape($global_config['mobileno']);?>
											</td>
										</tr>
										<tr>
											<td>
												<img src="<?php echo base_url('assets/images/email.png'); ?>" style="width: 35%;">
											</td>
											<td style="text-align: left;">
												<?php echo html_escape($global_config['institute_email']);?>
											</td>
										</tr>
										<tr>
											<td>
												<img src="<?php echo base_url('assets/images/web.png'); ?>" style="width: 35%;">
											</td>
											<td style="text-align: left;">
												<?php echo base_url('');?>
											</td>
										...
										<tr>
											<td>
												<img src="<?php echo base_url('assets/images/address.png'); ?>" style="width: 35%;">
											</td>
											<td style="text-align: left;">
												<?php echo html_escape($global_config['address']);?>
											</td>
										</tr>
									</table>
					...
					<div class="invoice">
						<header class="clearfix">
							<div class="row">
								<div class="col-md-6">
									<div class="ib">
										<img src="<?php echo base_url('uploads/app_image/printing-logo.png'); ?>" alt="techtune Img" style="width: 200px;" />
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-5 pull-right">
									<ul class="amounts">
										...
										<li><?php echo translate('discount'); ?> (<?php echo html_escape($currency_symbol); ?>) : <?php echo html_escape($total_discount); ?></li>
										<li><?php echo translate('tax'); ?> (<?php echo html_escape($currency_symbol); ?>) : <?php echo html_escape($tax_amount); ?></li>
										<li><?php echo translate('Grand Total'); ?> (<?php echo html_escape($currency_symbol); ?>) : <?php echo html_escape($net_amount); ?></li>

	...
	<div class="panel-body">
		...
		<table class="table table-bordered table-hover" cellspacing="0" width="100%" id="table-export">
			...
			<tbody>
				...
				<tr>
					<td>Total Bill</td>
					<td><?php echo html_escape( number_format($results['billsum']['total_amount'], 2, '.', '')); ?></td>
				</tr>
				<tr>
					<td>Total Discount</td>
					<td><?php echo html_escape( number_format($results['billsum']['total_discount'], 2, '.', '')); ?></td>
				</tr>
				<tr>
					<td>Total Tax</td>
					<td><?php echo html_escape( number_format($results['billsum']['total_tax'], 2, '.', '')); ?></td>
				</tr>
				<tr>
					<td>Total Net Payable</td>
					<td><?php echo html_escape( number_format($results['billsum']['net_amount'], 2, '.', '')); ?></td>
				</tr>
				<tr>
					<td>Total Paid</td>
					<td><?php echo html_escape( number_format($results['billsum']['totalpaid'], 2, '.', '')); ?></td>
				</tr>
				<tr>
					<td>Total Due</td>
					<td><?php echo html_escape( number_format(($results['billsum']['total_due'] + $results['billsum']['duecollect']), 2, '.', '')); ?></td>
				</tr>
				<tr>
					<td>Total Due Collection</td>
					<td><?php echo html_escape( number_format($results['billsum']['duecollect'], 2, '.', '')); ?></td>
				</tr>
				<tr>
					<td>Total Net Due</td>
					<td><?php echo html_escape( number_format($results['billsum']['total_due'], 2, '.', '')); ?></td>
				</tr>
				<tr>
					<td>Total Referral Commission</td>
					<td><?php echo html_escape( number_format($results['billsum']['total_commission'], 2, '.', '')); ?></td>
				</tr>
				<tr>
					<td>Total Production Cost</td>
					<td><?php echo html_escape( number_format($results['cost']['total_production_cost'], 2, '.', '')); ?></td>
				</tr>
				<tr>
					<td>Total Profit (After Referral Commission And Production Cost)</td>
					<td><?php echo html_escape( number_format(($results['billsum']['net_amount'] - $results['billsum']['total_commission'] - $results['cost']['total_production_cost']), 2, '.', '')); ?></td>
				</tr>
			</tbody>
		</table>
	</div>

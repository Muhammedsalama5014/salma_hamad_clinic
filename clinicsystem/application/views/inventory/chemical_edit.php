			...
			<div id="edit" class="tab-pane active">
	            <?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered validate')); ?>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="number" class="form-control" name="unit_ratio" id="unit_ratio" value="<?php echo html_escape($chemical['unit_ratio2']); ?>" required />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="datetime-local" class="form-control" name="admin_not_datetime" id="admin_not_datetime" value="<?php echo html_escape($chemical['admin_not_datetime']); ?>" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('Min Qty Notify'); ?> <span class="required">*</span></label>
						<div class="col-md-6">
							<input type="number" class="form-control" name="min_qty_noti" id="min_qty_noti" value="<?php echo html_escape($chemical['min_qty_noti']); ?>" />
						</div>
					</div>
					<div class="form-group">

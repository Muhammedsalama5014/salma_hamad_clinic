			...
			<div class="tab-pane active" id="create">
	            <?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered validate')); ?>
					...
					<div class="form-group <?php if (form_error('operate_by')) echo 'has-error'; ?>">
						...
						<div class="col-md-6">
							<select class="form-control operate_by" name="operate_by" required>
								...
								<option value="3" <?php if($schedule['operate_by']==3){echo "selected"; } ?>>Doctor</option>
								<option value="5" <?php if($schedule['operate_by']==5){echo "selected"; } ?>>Nurse</option>
								<option value="8" <?php if($schedule['operate_by']==8){echo "selected"; } ?>>Therapist</option>
								<option value="9" <?php if($schedule['operate_by']==9){echo "selected"; } ?>>HBO</option>
							</select>
					...
					<div class="form-group <?php if (form_error('doctor_id')) echo 'has-error'; ?>">
						...
						<div class="col-md-6">
							<select class="form-control doctor_id" name="doctor_id" required>
								<option>Select option</option>
							</select>
					...
					*/?>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="date" name="date" class="form-control" name="date" value="<?php echo set_value('date', $schedule['date']); ?>">
...
<script>
	...
	var doctor_id = "<?php echo $schedule['doctor_id'];?>";

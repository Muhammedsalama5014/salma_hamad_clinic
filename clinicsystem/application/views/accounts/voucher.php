							...
							<tr>
								...
								<td>
									<?php if (get_permission('voucher', 'is_edit')): ?>
										...
										<?php 
											if ($row['type']==='income' &&  $row['is_refund']!='1') {
										?>
										<a  class="btn btn-circle icon btn-primary refund" data-toggle="tooltip" data-original-title="<?php echo translate('Refund'); ?>" data-id="<?php echo $row['id']; ?>"> 
...
<script type="text/javascript">
    ...
    $('.refund').on('click', function(){
    	...
    	window.location.href=base_url+'accounts/refund_amount/'+id;
    });
</script>
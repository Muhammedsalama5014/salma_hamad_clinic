...
class Inventory extends Admin_Controller
{
    ...
    public function chemical_stock()
    {
        ...
        if (isset($_POST['stock'])) {
            ...
            $post = $this->input->post();
            $check_chemical_stock = $this->inventory_model->get_list('chemical_stock', array('chemical_id' => $post['chemical_id']), true);
            if (isset($check_chemical_stock['id']) && $check_chemical_stock['id'] != null) {
                set_alert('error', "You have stock to this item allready, Please add purchase if you went to add quantity");

...
class Employee extends Admin_Controller
{
    ...
    public function checkbyphone() 
    {
        ...
        $employeelist = $this->employee_model->get_employee_list_by_number($_POST['phone']);
    ...
    public function checkbyphone_new() 
    {
        
        $employeelist = $this->employee_model->get_employee_list_by_number($_POST['mobile_no']);
        if (count($employeelist)>0) {
            return 'no';
        } else {
           return 'yes';         
    ...
    public function getempbyrole( $role )
    {
        $data = $this->employee_model->get_employee_list($role);
    ...
    public function create()
    {
        ...
        if ($_POST) {
            ...
            $validPhone = $this->checkbyphone_new();
            if ($validPhone==='no') {
                set_alert('error', translate('Employee already exist with this phone number'));

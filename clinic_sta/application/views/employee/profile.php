                                    ...
                                    <div class="col-md-4 mb-sm">
                                        <div class="form-group <?php if (form_error('mobile_no')) echo 'has-error'; ?>">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control mobile_no" name="mobile_no" type="text" value="<?php echo set_value('mobile_no', $staff['mobileno']); ?>" required>
                                            </div>
...
<script>
    let oldphone = "<?php echo $staff['mobileno']; ?>";
    $('.mobile_no').on('change', function(){
        ...
        $.post(base_url+'employee/checkbyphone',
            {
                phone: $(this).val()
            },
        function(data, status){
            ...
            if (datafinal.status == false) {
                alert("Employee already exist with this phone number");
                $('.mobile_no').val('');
            }

			...
			<div id="create" class="tab-pane active">
	            <?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered validate')); ?>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								echo form_dropdown("chemical_category", $categorylist, set_value('assets_category', $chemical['category_id']), "class='form-control'
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								...
								echo form_dropdown("chemical_id", $chemical_list, set_value("assets_id"), "class='form-control' data-plugin-selectTwo
					...
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('current') . " " . translate('stock'); ?> (<?php echo translate('sales_unit'); ?>) <span class="required">*</span></label>
						<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="datetime-local" class="form-control" name="admin_not_datetime" id="admin_not_datetime" value="<?php echo html_escape($stock['admin_not_datetime']); ?>" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('Min Qty Notify'); ?> <span class="required">*</span></label>
						<div class="col-md-6">
							<input type="number" class="form-control" name="min_qty_noti" id="min_qty_noti" value="<?php echo html_escape($stock['min_qty_noti']); ?>" />
						</div>
					</div>
					<div class="form-group">

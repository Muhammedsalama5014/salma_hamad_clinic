							...
							<tfoot>
								<tr>
									...
									<td class="text-right" colspan="3">
										<b><?php echo translate('net_total'); ?> :</b><br><br>
										<b><?php echo translate('due'); ?> :</b>
									...
									<td class="text-right">
										...
										<input type="hidden" name="purchase_old_paid" class="text-right form-control" value="<?php echo html_escape($purchaselist['paid']); ?>">
										<input type="hidden" name="purchase_paid" class="text-right form-control page_num" value="<?php echo html_escape($purchaselist['paid']); ?>">
										<input type="text" name="purchase_due" class="text-right form-control" value="<?php echo html_escape($purchaselist['due']); ?>" readonly>
									</td>
								</tr>
							</tfoot>
						</table>

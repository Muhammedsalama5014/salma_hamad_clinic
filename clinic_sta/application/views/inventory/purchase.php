				...
				<?php echo form_open('inventory/purchase_save', array('id' => 'frmSubmit')); ?>
					...
					<div class="table-responsive">
						<table class="table table-bordered table-hover mt-md" id="tableID">
							<thead>
								<th><?php echo translate('assets'); ?> <span class="required">*</span></th>
							...
							<tbody>
								<tr id="row_0">
									...
									<td class="min-w-md">
										<div class="form-group">
											<input type="text" class="form-control purchase_discount page_num" oninput="validate_two_num(this)" name="purchases[0][discount]" value="0" />
										</div>
									</td>
									<td class="min-w-md">
										<div class="form-group">
...
<script type="text/javascript">
	...
	var validate_two_num = function(e) {
		var t = e.value;
...
<?php endforeach; ?>
		...
		html_row += '</div></td>';
		html_row += '<td><div class="form-group">';
		html_row += '<input type="text" name="purchases[' + value + '][discount]" class="form-control purchase_discount page_num" oninput="validate_two_num(this)" value="0" />';
		html_row += '</div></td>';

			...
			<div class="row mb-lg">
				...
				<div class="col-md-4 mt-sm">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="bill_date" value="<?php echo date("Y-m-d"); ?>" readonly id="bill_date" />
						<span class="error"></span>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6 mt-sm">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="delivery_date" value="<?php echo date("Y-m-d"); ?>" readonly id="delivery_date" />
						<span class="error"></span>
					</div>
				</div>
				<div class="col-md-6 mt-sm">
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" value="<?php echo date("H:i A"); ?>" readonly name="delivery_time" id="delivery_time" />
						</div>
						<span class="error"></span>
					</div>
				</div>
					...
					<div class="table-responsive">
						<table class="table table-bordered table-hover" id="tableID">
							<thead>
								...
								<th><?php echo "Service" . " " . translate('name'); ?></th>
							...
							<tbody>
								<tr id="row_0">
									...
									<td class="min-w-sm">
										<div class="form-group">
											<input  type="number" min="1" class="form-control unit_quantity" id="unit_quantity0" name="items[0][unit_quantity]" value="1" onchange="discount_update(0)" onkeyup="discount_update(0)" />
										</div>
									</td>
									<td width="320">
										<div class="form-group">
											<div class="discount-group">
												<div class="input-group" style="display: none;">
													...
													<input type="number" class="form-control" name="items[0][dis_percent]" id="dis_percent0" value="0"  readonly/>
												</div>
												<div class="amount-div">
													<input type="text" class="form-control items_discount" name="items[0][dis_amount]" id="dis_amount0" value="0" onchange="discount_update(0)" onkeyup="discount_update(0)" />
												</div>
											</div>
										</div>
									</td>
						...
						<div class="panel-body panel-body-custom">
							<table class="table b-less mb-none text-dark">
								<tbody>
									...
									<tr>
										...
										<td>
											<div class="form-group">
												...
												id='pay_via' required data-plugin-selectTwo data-width='100%'");
												?>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td colspan="2"><?php echo translate('Authorization no.'); ?></td>
										<td>
											<div class="form-group">
												<input type="text" class="form-control" name="authorization_no" placeholder="<?php echo translate('authorization_no'); ?>" />
											</div>
										</td>
									</tr>
...
<?php endforeach; ?>
		...
		html_row += '</div></td>';
		html_row += '<td><div class="form-group">';
		html_row += '<input type="number" min="1" name="items[' + value + '][unit_quantity]" id="unit_quantity' + value + '" class="form-control items_unit_quantity" value="1" onchange="discount_update(' + value + ')" onkeyup="discount_update(' + value + ')" />';
		html_row += '</div></td>';
		html_row += '<td><div class="form-group">';
		html_row += '<div class="discount-group"><div class="input-group"  style="display:none"><span class="input-group-addon">%</span>';
		html_row += '<input type="number" name="items[' + value + '][dis_percent]" id="dis_percent' + value + '" class="form-control"  value="0" readonly/>';
		html_row += '</div><div class="amount-div"><input type="text" class="form-control items_discount" name="items[' + value + '][dis_amount]" id="dis_amount' + value + '" value="0"  onchange="discount_update(' + value + ')" onkeyup="discount_update(' + value + ')" />';
	...
	function get_labtest_price(testid, rowid) {
		var from_date = $('#lab_test'+rowid).find(':selected').data('from_date');
		var to_date = $('#lab_test'+rowid).find(':selected').data('to_date');

							...
							<table class="table invoice-items table-hover tbr-top mb-none">
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center " style="<?= $class; ?>"><?php echo html_escape($currency_symbol . ($price - $discount)); ?></td>
									</tr>
									<?php } ?>
								</tbody>
							</table>
							...
							<div class="row">
								<div class="col-lg-5 pull-right">
									<ul class="amounts">
										...
										?>
										<li><?php echo html_escape($payment['pay_via']); ?> (<?php echo html_escape($currency_symbol); ?>) : <?php echo $payment['amount']; ?></li>
										<?php } ?>

			...
			<div class="row mb-lg">
				...
				<div class="col-md-4 mt-sm">
					<div class="form-group">
						...
						name="bill_date" value="<?php echo date("Y-m-d"); ?>" readonly id="bill_date" />
						<span class="error"></span>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6 mt-sm">
					<div class="form-group">
						...
						<input type="text" class="form-control" data-plugin-datepicker data-plugin-options='{ "todayHighlight" : true }' 
						name="delivery_date" value="<?php echo date("Y-m-d"); ?>" readonly id="delivery_date" />
						<span class="error"></span>
					</div>
				</div>
				<div class="col-md-6 mt-sm">
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="text" data-plugin-timepicker class="form-control" value="<?php echo date("H:i:s"); ?>" readonly name="delivery_time" id="delivery_time" />
						</div>
						<span class="error"></span>
					</div>
				</div>

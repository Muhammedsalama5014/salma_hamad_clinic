...
<body>
	<!-- Page Preloader -->
	<div class="loading-overlay dark" style="color:rgb(157, 211, 195) !important; text-shadow: 0 0 10px rgb(157, 211, 195) !important;" >
		<div class="ring-loader" style=" color:rgb(157, 211, 195) !important; text-shadow: 0 0 10px rgb(157, 211, 195) !important;" >
			Loading <span style=" color:rgb(157, 211, 195) !important; text-shadow: 0 0 10px rgb(157, 211, 195) !important;"></span>
		</div>
	</div>
	<section class="body">
		<!-- Top Navbar -->
	...
	<script type="text/javascript">
		...
		$('.noti-click').on('click', function(){
			
			$.ajax({url: "<?php echo base_url('documents/read_notifications')?>", success: function(result){

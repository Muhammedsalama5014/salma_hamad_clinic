                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-sm">
                            <div class="form-group <?php if (form_error('doc_type')) echo 'has-error'; ?>">
                                ...
                                <select name="doc_type" class="form-control" required>  
                                    ...
                                    <option value="Passport" <?php if($doc_data['doc_type']==='Passport') {echo "Selected";}?>>Passport</option>
                                    <option value="CivilId" <?php if($doc_data['doc_type']==='CivilId') {echo "Selected";}?>>Civil Id</option>
                        ...
                        <div class="col-md-6 mb-sm">
                            <div class="form-group <?php if (form_error('Admin Notify')) echo 'has-error'; ?>">
                                ...
                                <?php /*<input class="form-control" name="admin_notify" type="datetime-local" value="<?php echo $doc_data['admin_notify']; ?>" required  > */?>
                                <input class="form-control" name="admin_notify" type="date" value="<?php echo $doc_data['admin_notify']; ?>" required  >

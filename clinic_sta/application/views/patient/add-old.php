					...
					<div class="row">
						...
						<div class="col-md-4 mb-sm">
							<div class="form-group <?php if (form_error('patient_id')) echo 'has-error'; ?>">
								<label class="control-label"><?php echo translate('patient file id'); ?> <span class="required">*</span></label>
									<input class="form-control" name="patient_id" type="text" value="<?php echo set_value('patient_id'); ?>">
						...
						<div class="col-md-5 mb-sm">
							<div class="form-group ">
								...
								<div class="input-group">
									<span class="input-group-addon"><i class="far fa-user"></i></span>
									<input class="form-control" name="nationalid" type="text" >
								</div>
					...
					<div class="row">
						...
						<div class="col-md-6 mb-sm">
								<div class="form-group ">
									...
									<input type="text" class="form-control" name="debitbalance"  >	
								</div>
						</div>
						...
						<div class="col-md-6 mb-sm">
								<div class="form-group ">
									...
									<input type="text" class="form-control" name="creditbalance"  >	
								</div>
						</div>
						...
						<div class="col-md-6 mb-sm">
							<div class="form-group <?php if (form_error('mobile_no')) echo 'has-error'; ?>">
								...
								<div class="input-group">
									...
									<input class="form-control mobile_no" name="mobile_no" type="text" value="<?php echo set_value('mobile_no'); ?>" required>
								</div>

		...
		<div class="tab-content">
			<div class="tab-pane box <?php echo (empty($active_tab) ? 'active' : ''); ?>" id="setting">
				<?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered validate')); ?>
					...
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('institute_email'); ?></label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="institute_email" value="<?php echo set_value('institute_email', $global_config['institute_email']); ?>" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="col-md-3 control-label">Patient Start Id</label>
						<div class="col-md-6 mb-md">
							<input type="text" class="form-control" name="patient_start_id" value="<?php echo set_value('patient_start_id', $global_config['patient_start_id']); ?>" />
						</div>
					</div>
